...
export const SorusturmaUzlasmaTeklifQuestions: Question[] = [
    new TextboxQuestion({
        label: 'Suçlar',
        key: 'crimes',
        required: true,
...
export class SorusturmaUzlasmaTeklif extends BaseTemplate<SorusturmaUzlasmaTeklifProps> {
    protected prepareDocument(props: SorusturmaUzlasmaTeklifProps) {
        ...
        this.text(competentAuthority.name.toLocaleUpperCase(), TextAlign.Center).bold();
        ...
        this.text('A. ', p2).bold();
        this.text([
            '5271 sayılı Ceza Muhakemesi Kanunu\'nun 253 üncü maddesi çerçevesinde, soruşturma konusu ',
            extraData.crimes,
